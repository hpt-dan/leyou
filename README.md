...
### 1.1.4：商品的增删改
## 1.2：搜索
#### 2.1.1：输入关键子，在搜索页面显示与该关键字的有关的品牌分类。和该关键字有关的可以供搜索的规格参数和对应的值。商品的一些简介，并且提供分页
#### 2.1.2：我们点击品牌和分类和这些规格参数能够对搜索结果进行过滤。
## 1.3：登录注册
### 3.1.1：能够用短信进行注册
### 3.1.2：单点登录，并保证客服的安全性
## 1.4：购物车
### 4.1.1：商品详情页的显示
### 4.1.2：无登录的购物车
### 4.1.3：登录状态下的购物车
### 4.1.4：登录后，将无登录的购物车里的商品进行合并
## 1.5：订单支付
### 5.1.1：能够下订单
### 5.1.2：订单的微信支付
### 5.1.3：订单的定时清理
